...
public class DBAcessResult {
  ...
  private   String error="";
     ...
     */
        ...
        public String  executeQueryXML(String sql,Object[]params)
        {
            try {
                  DataXMLTable result = ComDataTable.createXMLDataTable(db.executeQueryRS(sql, params));
